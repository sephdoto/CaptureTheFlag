...
import org.ctf.UI.customObjects.BackgroundRepV1;
import org.ctf.UI.customObjects.FigureRepV1;

/**
 * mkrakows Generates the code for the Scene in that one can choose a Map a show it on the screen
 * @author mkrakows
...
public class LoadMapSceneController implements Initializable {
   ...
   *     generated by Using the same custom Rectangle Class for now {@link customObjects.FigureRepV1
   *     }
   */
  @Override
