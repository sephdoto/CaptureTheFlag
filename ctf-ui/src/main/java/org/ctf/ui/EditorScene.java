 ...
 * components for loading, customizing, rendering and saving map templates.
 * 
 * @author aniemesc
 */
public class EditorScene extends Scene {
	 ...
	 * panes and connects it to a CSS file.
	 * 
	 * @author aniemesc
...
//    textGeneratorThread.start();
	...
	/**
	 * Presents text input on the UI by setting the infoText attribute and playing a
	 * FadeTransition.
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates all necessary UI components for the option pane that allows users to
	 * set general template parameters. It consists of a grid containing different
	 * spinners and combo boxes and their corresponding labels.
	 * 
	 * @author aniemesc
	...
	private VBox createMapChooser() {
		...
		Spinner<Integer> turnTimeSpinner = createMapSpinner(-1, 600, engine.tmpTemplate.getMoveTimeLimitInSeconds());
	...
	/**
	 * Creates all necessary UI components for the option pane that allows users to
	 * add pieces on the map. It consists of a grid containing spinners for default
	 * pieces and a combo box for selecting custom pieces.
	 * 
	 * @author aniemesc
...
//    pieceRoot.setSpacing(10);
	...
	/**
	 * Creates all necessary UI components for the option pane that allows users to
	 * customize and add their own pieces. It consists of a grid containing several
	 * control items and their corresponding labels.
	 * 
	 * @author aniemesc
	 * @return VBox - main container of "Add Pieces" option
	 */
...
//    customRoot.getChildren().add(test);
		...
		playButton.setOnAction(e -> {
			SoundController.playSound("Queen",Themes.valueOf(themeBox.getValue()) ,SoundType.valueOf(soundBox.getValue()));
		});
	...
	/**
	 * Creates the Container for displaying the different option tabs on the left
	 * side of the scene.
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates the container that displays the menu buttons for loading a map and
	 * switching between option tabs
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates the MenuButton which allows the user to switch between the option
	 * tabs "Edit Map","Add Pieces" and "Custom Pieces".
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates the MenuButton which allows the user to load map templates into the
	 * editor scene.
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates a MenuItem and adds it to the MapMenuButton. When triggered it causes
	 * the corresponding map template to be loaded in the map editor.
	 * 
	 * @author aniemesc
	...
	/**
	 * Styles the ComboBox responsible for choosing saved custom pieces in the "Add
	 * Pieces" option tab.
	 * 
	 * @author aniemesc
	 * @return ComboBox for choosing saved pieces
	 */
	private void createFigureBox(ComboBox<String> box,double widthratio,double heightratio,double fontratio) {
	...
	/**
	 * Creates and styles the ComboBox responsible for choosing a movement shape in
	...
	/**
	 * Creates and styles the ComboBox responsible for choosing a direction in the
	 * "Configure Pieces" option tab.
	 * 
	 * @author aniemesc
	...
	/**
	 * Creates the container for the UI components required for adding custom pieces
	 * in the Add Pieces" option tab.
	 * 
	 * @param vBox - Container used for resize dependency
	 * @return HBox container
	 */
	...
	/**
	 * Creates and styles a TextField for naming custom pieces in the "Configure
	 * Pieces" option tab.
	 * 
	 * @author aniemesc
	 * @param vbox - Container used for resize dependency
	...
	/**
	 * Creates and styles a Button for adding custom pieces in the "Configure
	 * Pieces" option tab.
	 * 
	 * @author aniemesc
	 * @param vbox     - Container used for resize dependency
	...
	/**
	 * Creates the container for the visual map representation and calls methods for
	 * initializing its content.
	 * 
	 * @author aniemesc
	 */
	 ...
	 * @param custom  - boolean value that tells you whether the spinner is for
	 *                custom pieces
	 */
