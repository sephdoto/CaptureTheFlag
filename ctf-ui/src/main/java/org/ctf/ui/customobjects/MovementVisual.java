...
/**
 * Displays a visual representation for the movement options for a custom piece in the map editor.
 * Consists of a grid of StackPanes and a connection to a TemplateEngine to update current move
 * option.
 * 
 * @author aniemesc
 */
public class MovementVisual extends GridPane {
  ...
  /**
   * Creates Consumer Objects used for updating the grid. Consumers change opacity of circle objects
