...
public class MyCustomColorPicker extends VBox {
	private final ObjectProperty<Color> currentColorProperty = 
	    ...
	    private SimpleDoubleProperty hue = new SimpleDoubleProperty(-1);
	    private SimpleDoubleProperty sat = new SimpleDoubleProperty(-1);
	    private SimpleDoubleProperty bright = new SimpleDoubleProperty(-1);

	    private SimpleDoubleProperty alpha = new SimpleDoubleProperty(100) {
	    ...
	    public MyCustomColorPicker() {
	        ...
	        Label l = new Label("Select your Team Color");
	        l.setFont(Font.font(15));
	        l.textFillProperty().bind(customColorProperty);
	        HBox h = new HBox();
	        h.setAlignment(Pos.CENTER);
	       
	        h.getChildren().add(l);
	          ///////////////////////////////////////////////////////
	        box.getChildren().addAll(h,colorBar, colorRect, newColorRect);
