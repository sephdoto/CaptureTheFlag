...
class MCTS_ToolsTest {
  ...
  void testPossibleMoves() {
    ...
    MCTSUtilities.getPossibleMoves(node.gameState, piece, possibleMoves, new ReferenceMove(null, new int[2]));
  ...
  void testPickMoveComplex() {
    try {
      MCTSUtilities.pickMoveComplex(rGameState, new ReferenceMove(null, new int[2]));
  ...
  void testValidDirection() {
      ...
      assertFalse(MCTSUtilities.validDirection(rGameState, rook, 1, new ReferenceMove(null, new int[2])));           
      //a piece on the right doesn't allow the movement to the right
      assertTrue(MCTSUtilities.validDirection(rGameState, rook, 2, new ReferenceMove(null, new int[2])));            
      //there's a free position above, this direction is accessible
      assertTrue(MCTSUtilities.validDirection(rGameState, rook, 3, new ReferenceMove(null, new int[2])));            
      //there's a free position below, this direction is accessible
      assertTrue(MCTSUtilities.validDirection(rGameState, rook, 4, new ReferenceMove(null, new int[2])));            
      //there's a free position above-left, this direction is accessible
      assertTrue(MCTSUtilities.validDirection(rGameState, rook, 5, new ReferenceMove(null, new int[2])));            
      //there's a free position above-right, this direction is accessible
      assertTrue(MCTSUtilities.validDirection(rGameState, rook, 6, new ReferenceMove(null, new int[2])));            
      //there's a free position below-left, this direction is accessible
      assertFalse(MCTSUtilities.validDirection(rGameState, rook, 7, new ReferenceMove(null, new int[2])));           
  ...
  void testCheckMoveValidity() {
      ...
      assertNull(MCTSUtilities.checkMoveValidity(rGameState, rook, 1, 1, new ReferenceMove(null, new int[2])).getPiece());      
      //rook cannot walk onto another same team rook
      assertNotNull(MCTSUtilities.checkMoveValidity(rGameState, rook, 2, 1, new ReferenceMove(null, new int[2])).getPiece());
      //rook can walk on the empty space above
      assertNull(MCTSUtilities.checkMoveValidity(rGameState, rook, 2, 3, new ReferenceMove(null, new int[2])).getPiece());
      //rook cannot jump over the block above
      assertNotNull(MCTSUtilities.checkMoveValidity(rGameState, rook, 3, 1, new ReferenceMove(null, new int[2])).getPiece());
      //rook can walk on the empty space below
      assertNotNull(MCTSUtilities.checkMoveValidity(rGameState, rook, 6, 1, new ReferenceMove(null, new int[2])).getPiece());
      //piece could go to the empty field below-left
      assertNull(MCTSUtilities.checkMoveValidity(rGameState, rook2, 4, 4, new ReferenceMove(null, new int[2])).getPiece());
      //piece could not walk over a block to the empty field above-left 3,1
      assertNull(MCTSUtilities.checkMoveValidity(rGameState, rook2, 4, 0, new ReferenceMove(null, new int[2])).getPiece());
  ...
  void testGetRandomShapeMove() {
      ...
      assertEquals(move1.getNewPosition(), MCTSUtilities.getRandomShapeMove(moveList, null, new ReferenceMove(null, new int[2])).getNewPosition());
      assertEquals(move1.getPieceId(), MCTSUtilities.getRandomShapeMove(moveList, null, new ReferenceMove(null, new int[2])).toMove().getPieceId());
  }
  ...
  void testCreateDirectionMap() {
    GameState gameState = TestValues.getTestState();
      ...
      assertArrayEquals(dirMap.toArray(), MCTSUtilities.createDirectionMap
      ...
      assertEquals(new ArrayList<int[]>(), MCTSUtilities.createDirectionMap(
  ...
  void testGetDirectionMove() {
      ...
      int[] newPosition = MCTSUtilities.getDirectionMove(
